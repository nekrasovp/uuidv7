...
INVALID = ["", "x" * 36, TEXTS[0][:-1], TEXTS[0] + "0", "０" * 32,
           TEXTS[0][:15] + "\0" + TEXTS[0][16:], " " + TEXTS[0],
           TEXTS[0].replace("-", "_"), "urn:UUID:" + TEXTS[0]]
...
def identity():
    packages = ["fastuuid7", "fastuuid", "uuid-utils", "pydantic", "pydantic-core",
                "fastapi", "starlette", "uvicorn", "pyperf", "psycopg"]
    return {
